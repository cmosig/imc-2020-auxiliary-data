...
##chains = 2
##
##fit_uniform = sm_uniform.sampling(data=data_dict_test, iter=iterations, chains=chains)#,algorithm="HMC")
##
...
##chains = 2
##
##fit_prior0 = sm_prior0.sampling(data=data_dict_test, iter=iterations, chains=chains)#,algorithm="HMC")
### print(fit_test)
##
...
##chains = 2
##
##fit_prior1 = sm_prior1.sampling(data=data_dict_test, iter=iterations, chains=chains)#,algorithm="HMC")
### print(fit_test)
##
